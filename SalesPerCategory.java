...
iimport org.apache.hadoop.conf.Configuration;
...
public final class SalesPerCategory {
	...
	public final static void main(final String[] args) throws Exception {
		...
		final Job job = new Job(conf, "SalesPerCategory");
